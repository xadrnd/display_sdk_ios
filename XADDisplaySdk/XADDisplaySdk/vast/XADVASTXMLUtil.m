...
@implementation XADVASTXMLUtil:NSObject
...
+ (BOOL) validateXMLDocAgainstSchema: (NSData*) document schema:(NSData*)schemaData
{
    xmlSetGenericErrorFunc(NULL, (xmlGenericErrorFunc)documentParserErrorCallback);
...
+ (NSArray* __nullable) performXMLXPathQuery: (NSData*)document query:(NSString*)query
{
    xmlDocPtr doc;
